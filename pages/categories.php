...
<html>
<head>
<title>TokunboMall | Categories</title>
...
<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.php"><span>Tokunbo</span>Mall</a>
			</div>
	...
	<div class="banner text-center">
	  <div class="container">    
			<h1>Sell used  <span class="segment-heading">things online </span> with Tokunbo Mall</h1>
						...
						<div class="col-md-3 footer-grid">
							...
							<address>
								...
								<ul class="location">
									...
									<li>+234 809 615 7029</li>
									<div class="clearfix"></div>
								</ul>	
								<ul class="location">
									<li><span class="glyphicon glyphicon-envelope"></span></li>
									<li><a href="mailto:tokunbomall@gmail.com"> tokunbomall@gmail.com</a></li>
									<div class="clearfix"></div>
								</ul>						
							</address>
						</div>
