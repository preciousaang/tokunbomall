  ...
  <div class="container">
    ...
    <div class="product-desc">
      <div class="col-md-7 product-view">
        ...
        <p> <i class="glyphicon glyphicon-map-marker"></i><a href="#"><?php echo str_replace(" State", "", $product->find_product_state()); ?></a>, <a href="#"><?php echo $product->find_product_region(); ?></a>| Added at <?php echo $product->upload_time; ?>, Ad ID: 987654321</p>
